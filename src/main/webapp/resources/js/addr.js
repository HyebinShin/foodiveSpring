...
const execDaumPostcode = () => {
    new daum.Postcode({
        oncomplete: function(data) {
            ...
            document.querySelector('#zipcode').value = data.zonecode; //5자리 새우편번호 사용
...
document.addEventListener("DOMContentLoaded", () => {
    const searchZipcode = document.querySelector('#search_zipcode');

    searchZipcode.addEventListener("click", () => {
        execDaumPostcode();
    });
});